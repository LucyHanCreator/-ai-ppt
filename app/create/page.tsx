...
export default function CreatePage({ searchParams }: { searchParams: { type?: string | string[]; lang?: string | string[] } }) {
    ...
    <main className="shell">
      <nav className="nav">
        ...
        <div className="language-switch">
          <Link className={locale === "zh" ? "active" : ""} href={`/create?type=${initialType}&lang=zh`}>
            {t.languageZh}
          </Link>
          <Link className={locale === "en" ? "active" : ""} href={`/create?type=${initialType}&lang=en`}>
            {t.languageEn}
          </Link>
        </div>
      </nav>
